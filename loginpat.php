...
<head>
  ...
  <script src="./scripts/patregistervalidate.js"></script>
...
<body>
          ...
          <form action="" method="post" onsubmit="return validateForm()" name="myForm">
            <div id="form1">
              <div class="input-boxes">
                ...
                <div class="input-box">
                  ...
                  <input type="email" placeholder="Enter your email" name="email" onkeyup="emailCheck(this.value)" required>
                </div>
                <p id="emailCheck"></p>
                <div class="input-box">
            ...
            <div id="form2">
              <div class="input-boxes">
                ...
                <div class="input-box">
                  <i class="fas fa-user"></i>
                  <input type="text" placeholder="Enter your username" name="username" onkeyup="usernameCheck(this.value)" required>
                </div>
                <p id="userCheck"></p>
                <div class="input-box">
  ...
  <script>
    ...
    function emailCheck(value) {
      let request = new XMLHttpRequest();
      request.open('GET', './index-content/emailpat.php?email=' + value);
